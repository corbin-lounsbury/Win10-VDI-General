source "vsphere-iso" "autogenerated_1" {
  ...
  firmware              = "efi-secure"
  floppy_files          = ["./win10.vdi/autounattend.xml", "./scripts/disable-network-discovery.cmd", "./scripts/enable-rdp.cmd", "./scripts/enable-winrm.ps1", "./scripts/install-vm-tools.cmd", "./scripts/set-temp.ps1"]
